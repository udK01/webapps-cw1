...
@if ($loggedIn == $post->user->id || Auth::user()->permission >= 1)
    ...
    <div class="box">
        <div class="buttons">
            {{-- Back --}}
            <a href="{{ route('home.show', ['id' => $post->id]) }}" class="btn btn-2" style="color: #F0F4EF">Back</a>
            ...
            {{-- Submit --}}
            <button type="submit" form="postForm" class="btn btn-2" style="color: #F0F4EF;">Submit</button>
        </div>
    </div>     
@endif
@endsection
