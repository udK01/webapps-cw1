...
@section('content')
    ...
    style="position: relative;border: 1px solid;bottom: -5px;border-color: red;
    padding: 10px;box-shadow: 5px 10px #FF0000;font-size: 325%;">This is not your post. Nice Try.
    </div>
    {{-- Back --}}
    <a href="{{ route('home.show', ['id' => $post->id]) }}"><button 
    style="position: relative;border: 1px solid;bottom: -25px;right: 305px;border-color: black;
    padding: 10px;box-shadow: 5px 10px #808080;font-size: 225%;">Back</button></a>
    @endif
@endsection